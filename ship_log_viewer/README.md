...
- `ship_log_viewer/start_ship_log_viewer.bat`
...
[viewer] Root: C:\...\Black_Pearl_v2.0-main
[viewer] URL : http://127.0.0.1:8000/ship_log_viewer/ship_log_viewer.html
```
...
- `[HDG] I: ...`
- `[AHRS] I: rpy=... gy=... flg=...`
- `[HDG] I: abs=... rel=... mag=... rdy=... st=... set=... err=... pred=...`
- `[MAG] I: test raw=...`

### 9.3 遥控与动作类

- `[SHIP] I: rc11 on`
- `[SHIP] I: rc cmd=0x11 lr=... ud=... tv=... sv=... key=0x...`
- `[SHIP] I: key edge key=0x... action=...`
- `[CTRL] I: out mode=... motion=... base=... diff=... left=... right=...`
- `[DATA] I: cruise enter ...`
- `[DATA] I: cruise exit ...`
- `[SHIP] I: manual parse ...`
...
- `[SHIP] I: tx cmd=0x12 ...`
- `[SHIP] I: tx cmd=0x12 ch=... payload_len=...`
- `[SHIP] I: gps state ...`
...
- `[SHIP] I: coord ...`
- `[SHIP] I: 0x13 return-home event ...`
- `[SHIP] I: 0x14 fish-point event ...`
- `[SHIP] I: 0x14 rx fl=... pl=... xor=... res=... idx=...`
- `[SHIP] I: 0x15 return-switch event ...`
...
1. 双击 `ship_log_viewer/start_ship_log_viewer.bat`
2. 选串口后点连接
3. 先看“配对状态”和“遥控链路”
4. 再看“控制模式”和“电机输出”
5. 按键是否触发直接看“按键状态”
...
- 上位机主页面：
  [ship_log_viewer.html](/C:/Users/S/Desktop/STC_PROJECT/Black_Pearl_v2.0-main/ship_log_viewer/ship_log_viewer.html)
- 启动脚本：
  [start_ship_log_viewer.bat](/C:/Users/S/Desktop/STC_PROJECT/Black_Pearl_v2.0-main/ship_log_viewer/start_ship_log_viewer.bat)
